...
.PHONY: db-migrate-postgres db-migrate-mysql db-migrate-sqlite db-migrate-all \
        sqlx-prepare-postgres sqlx-prepare-mysql sqlx-prepare-sqlite sqlx-prepare-all \
        db-clean
...
db-migrate-all: db-migrate-postgres db-migrate-mysql db-migrate-sqlite
...
sqlx-prepare-all: sqlx-prepare-postgres sqlx-prepare-mysql sqlx-prepare-sqlite
